      ...
      <div className="container mx-auto px-4 py-4 h-full flex flex-col relative z-10">
        ...
        <div className="flex-1 flex items-center justify-center min-h-0">
          <div className="max-w-md w-full mx-auto">
            <div className="bg-gray-800/70 backdrop-blur-sm border border-cyan-500/30 rounded-xl shadow-2xl shadow-cyan-500/20 p-8 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                {loginError && (
                  <div className="mb-4 p-3 bg-red-900/50 border border-red-500/50 text-red-200 rounded-lg backdrop-blur-sm">
                    {loginError}
                  </div>
                )}
                ...
                <form onSubmit={handleLoginSubmit}>
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 text-base bg-gray-900/50 border border-cyan-400/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent text-cyan-100 placeholder-cyan-300/60 backdrop-blur-sm"
